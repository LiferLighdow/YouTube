...
public class YouTubeWebViewClient extends WebViewClient {
	...
	public YouTubeWebViewClient(MainActivity activity, YouTubeWebView web) {
    ...
    url.contains("SetSID")) {             
		...
		if (url.contains("youtube.com/ytpro_cdn/npm/ytpro@latest")) {
			String assetPath = "script.js";
			if (url.endsWith("bgplay.js")) assetPath = "bgplay.js";
			else if (url.endsWith("innertube.js")) assetPath = "innertube.js";
			...
			try {
				...
				Log.e("YTPRO_WVC", "Failed to load asset: " + assetPath);
			}
		}
