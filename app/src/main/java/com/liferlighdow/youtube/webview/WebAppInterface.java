package com.liferlighdow.youtube.webview;
...
import com.liferlighdow.youtube.ForegroundService;
import com.liferlighdow.youtube.GeminiWrapper;
import com.liferlighdow.youtube.MainActivity;
import com.liferlighdow.youtube.R;
import com.liferlighdow.youtube.utils.DownloadUtils;
import com.liferlighdow.youtube.utils.MediaMuxerUtils;
...
public class WebAppInterface {
	...
	public WebAppInterface(MainActivity activity, YouTubeWebView web) {
	...
	public void muxVideoAudio(String videoFileName,String audioFileName,String outputFileName) {
		java.io.File downloads = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS.concat("/YouTube"));
	...
	public void setBgPlay(boolean bgplay) {
		activity.getSharedPreferences("YouTube", Context.MODE_PRIVATE).edit().putBoolean("bgplay", bgplay).apply();
	}
